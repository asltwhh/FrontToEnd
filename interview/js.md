转载于：https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md

### 目录

- [1. 介绍 js 的基本数据类型。](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#1-介绍-js-的基本数据类型)
- [2. JavaScript 有几种类型的值？你能画一下他们的内存图吗？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#2-javascript-有几种类型的值你能画一下他们的内存图吗)
- [3. 什么是堆？什么是栈？它们之间有什么区别和联系？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#3-什么是堆什么是栈它们之间有什么区别和联系)
- [4. 内部属性 [[Class\]] 是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#4-内部属性-class-是什么)
- [5. 介绍 js 有哪些内置对象？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#5-介绍-js-有哪些内置对象)
- [6. undefined 与 undeclared 的区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#6-undefined-与-undeclared-的区别)
- [7. null 和 undefined 的区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#7-null-和-undefined-的区别)
- [8. 如何获取安全的 undefined 值？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#8-如何获取安全的-undefined-值)
- [9. 说几条写 JavaScript 的基本规范？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#9-说几条写-javascript-的基本规范)
- [10. JavaScript 原型，原型链？ 有什么特点？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#10-javascript-原型原型链-有什么特点)
- [11. js 获取原型的方法？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#11-js-获取原型的方法)
- [12. 在 js 中不同进制数字的表示方式](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#12-在-js-中不同进制数字的表示方式)
- [13. js 中整数的安全范围是多少？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#13-js-中整数的安全范围是多少)
- [14. typeof NaN 的结果是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#14-typeof-nan-的结果是什么)
- [15. isNaN 和 Number.isNaN 函数的区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#15-isnan-和-numberisnan-函数的区别)
- [16. Array 构造函数只有一个参数值时的表现？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#16-array-构造函数只有一个参数值时的表现)
- [17. 其他值到字符串的转换规则？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#17-其他值到字符串的转换规则)
- [18. 其他值到数字值的转换规则？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#18-其他值到数字值的转换规则)
- [19. 其他值到布尔类型的值的转换规则？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#19-其他值到布尔类型的值的转换规则)
- [20. {} 和 [\] 的 valueOf 和 toString 的结果是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#20--和--的-valueof-和-tostring-的结果是什么)
- [21. 什么是假值对象？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#21-什么是假值对象)
- [22. ~ 操作符的作用？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#22--操作符的作用)
- [23. 解析字符串中的数字和将字符串强制类型转换为数字的返回结果都是数字，它们之间的区别是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#23-解析字符串中的数字和将字符串强制类型转换为数字的返回结果都是数字它们之间的区别是什么)
- [24. 操作符什么时候用于字符串的拼接？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#24--操作符什么时候用于字符串的拼接)
- [25. 什么情况下会发生布尔值的隐式强制类型转换？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#25-什么情况下会发生布尔值的隐式强制类型转换)
- [26. || 和 && 操作符的返回值？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#26--和--操作符的返回值)
- [27. Symbol 值的强制类型转换？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#27-symbol-值的强制类型转换)
- [28. == 操作符的强制类型转换规则？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#28--操作符的强制类型转换规则)
- [29. 如何将字符串转化为数字，例如 '12.3b'?](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#29-如何将字符串转化为数字例如-123b)
- [30. 如何将浮点数点左边的数每三位添加一个逗号，如 12000000.11 转化为『12,000,000.11』?](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#30-如何将浮点数点左边的数每三位添加一个逗号如1200000011转化为1200000011)
- [31. 常用正则表达式](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#31-常用正则表达式)
- [32. 生成随机数的各种方法？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#32-生成随机数的各种方法)
- [33. 如何实现数组的随机排序？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#33-如何实现数组的随机排序)
- [34. javascript 创建对象的几种方式？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#34-javascript-创建对象的几种方式)
- [35. JavaScript 继承的几种实现方式？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#35-javascript-继承的几种实现方式)
- [36. 寄生式组合继承的实现？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#36-寄生式组合继承的实现)
- [37. Javascript 的作用域链？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#37-javascript-的作用域链)
- [38. 谈谈 This 对象的理解。](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#38-谈谈-this-对象的理解)
- [39. eval 是做什么的？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#39-eval-是做什么的)
- [40. 什么是 DOM 和 BOM？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#40-什么是-dom-和-bom)
- [41. 写一个通用的事件侦听器函数。](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#41-写一个通用的事件侦听器函数)
- [42. 事件是什么？IE 与火狐的事件机制有什么区别？ 如何阻止冒泡？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#42-事件是什么ie-与火狐的事件机制有什么区别-如何阻止冒泡)
- [43. 三种事件模型是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#43-三种事件模型是什么)
- [44. 事件委托是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#44-事件委托是什么)
- [45. ["1", "2", "3"\].map(parseInt) 答案是多少？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#45-1-2-3mapparseint-答案是多少)
- [46. 什么是闭包，为什么要用它？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#46-什么是闭包为什么要用它)
- [47. javascript 代码中的 "use strict"; 是什么意思 ? 使用它区别是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#47-javascript-代码中的-use-strict-是什么意思--使用它区别是什么)
- [48. 如何判断一个对象是否属于某个类？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#48-如何判断一个对象是否属于某个类)
- [49. instanceof 的作用？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#49-instanceof-的作用)
- [50. new 操作符具体干了什么呢？如何实现？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#50-new-操作符具体干了什么呢如何实现)
- [51. Javascript 中，有一个函数，执行时对象查找时，永远不会去查找原型，这个函数是？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#51-javascript中有一个函数执行时对象查找时永远不会去查找原型这个函数是)
- [52. 对于 JSON 的了解？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#52-对于-json-的了解)
- [53. `[\].forEach.call($$("*"),function(a){a.style.outline="1px solid #"+(~~(Math.random()*(1<<24))).toString(16)})` 能解释一下这段代码的意思吗？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#53-foreachcallfunctionaastyleoutline1px-solid-mathrandom124tostring16-能解释一下这段代码的意思吗)
- [54. js 延迟加载的方式有哪些？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#54-js-延迟加载的方式有哪些)
- [55. Ajax 是什么? 如何创建一个 Ajax？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#55-ajax-是什么-如何创建一个ajax)
- [56. 谈一谈浏览器的缓存机制？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#56-谈一谈浏览器的缓存机制)
- [57. Ajax 解决浏览器缓存问题？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#57-ajax-解决浏览器缓存问题)
- [58. 同步和异步的区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#58-同步和异步的区别)
- [59. 什么是浏览器的同源政策？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#59-什么是浏览器的同源政策)
- [60. 如何解决跨域问题？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#60-如何解决跨域问题)
- [61. 服务器代理转发时，该如何处理 cookie？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#61-服务器代理转发时该如何处理-cookie)
- [62. 简单谈一下 cookie ？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#62-简单谈一下-cookie-)
- [63. 模块化开发怎么做？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#63-模块化开发怎么做)
- [64. js 的几种模块规范？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#64-js-的几种模块规范)
- [65. AMD 和 CMD 规范的区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#65-amd-和-cmd-规范的区别)
- [66. ES6 模块与 CommonJS 模块、AMD、CMD 的差异。](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#66-es6-模块与-commonjs-模块amdcmd-的差异)
- [67. requireJS 的核心原理是什么？（如何动态加载的？如何避免多次加载的？如何 缓存的？）](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#67-requirejs-的核心原理是什么如何动态加载的如何避免多次加载的如何-缓存的)
- [68. JS 模块加载器的轮子怎么造，也就是如何实现一个模块加载器？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#68-js-模块加载器的轮子怎么造也就是如何实现一个模块加载器)
- [69. ECMAScript6 怎么写 class，为什么会出现 class 这种东西?](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#69-ecmascript6-怎么写-class为什么会出现-class-这种东西)
- [70. documen.write 和 innerHTML 的区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#70-documenwrite-和-innerhtml-的区别)
- [71. DOM 操作——怎样添加、移除、移动、复制、创建和查找节点？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#71-dom-操作怎样添加移除移动复制创建和查找节点)
- [72. innerHTML 与 outerHTML 的区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#72-innerhtml-与-outerhtml-的区别)
- [73. .call() 和 .apply() 的区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#73-call-和-apply-的区别)
- [74. JavaScript 类数组对象的定义？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#74-javascript-类数组对象的定义)
- [75. 数组和对象有哪些原生方法，列举一下？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#75-数组和对象有哪些原生方法列举一下)
- [76. 数组的 fill 方法？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#76-数组的-fill-方法)
- [77. [,,,\] 的长度？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#77--的长度)
- [78. JavaScript 中的作用域与变量声明提升？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#78-javascript-中的作用域与变量声明提升)
- [79. 如何编写高性能的 Javascript ？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#79-如何编写高性能的-javascript-)
- [80. 简单介绍一下 V8 引擎的垃圾回收机制](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#80-简单介绍一下-v8-引擎的垃圾回收机制)
- [81. 哪些操作会造成内存泄漏？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#81-哪些操作会造成内存泄漏)
- [82. 需求：实现一个页面操作不会整页刷新的网站，并且能在浏览器前进、后退时正确响应。给出你的技术实现方案？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#82-需求实现一个页面操作不会整页刷新的网站并且能在浏览器前进后退时正确响应给出你的技术实现方案)
- [83. 如何判断当前脚本运行在浏览器还是 node 环境中？（阿里）](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#83-如何判断当前脚本运行在浏览器还是-node-环境中阿里)
- [84. 把 script 标签放在页面的最底部的 body 封闭之前和封闭之后有什么区别？浏览器会如何解析它们？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#84-把-script-标签放在页面的最底部的-body-封闭之前和封闭之后有什么区别浏览器会如何解析它们)
- [85. 移动端的点击事件的有延迟，时间是多久，为什么会有？ 怎么解决这个延时？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#85-移动端的点击事件的有延迟时间是多久为什么会有-怎么解决这个延时)
...
- [87. 如何测试前端代码么？ 知道 BDD, TDD, Unit Test 么？ 知道怎么测试你的前端工程么(mocha, sinon, jasmin, qUnit..)？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#87-如何测试前端代码么-知道-bdd-tdd-unit-test-么-知道怎么测试你的前端工程么mocha-sinon-jasmin-qunit)
...
- [89. 什么是 Polyfill ？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#89-什么是-polyfill-)
- [90. 使用 JS 实现获取文件扩展名？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#90-使用-js-实现获取文件扩展名)
- [91. 介绍一下 js 的节流与防抖？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#91-介绍一下-js-的节流与防抖)
- [92. Object.is() 与原来的比较操作符 “===”、“==” 的区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#92-objectis-与原来的比较操作符--的区别)
- [93. escape,encodeURI,encodeURIComponent 有什么区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#93-escapeencodeuriencodeuricomponent-有什么区别)
- [94. Unicode 和 UTF-8 之间的关系？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#94-unicode-和-utf-8-之间的关系)
- [95. js 的事件循环是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#95-js-的事件循环是什么)
- [96. js 中的深浅拷贝实现？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#96-js-中的深浅拷贝实现)
- [97. 手写 call、apply 及 bind 函数](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#97-手写-callapply-及-bind-函数)
- [98. 函数柯里化的实现](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#98-函数柯里化的实现)
- [99. 为什么 0.1 0.2 != 0.3？如何解决这个问题？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#99-为什么-01--02--03如何解决这个问题)
...
- [101. toPrecision 和 toFixed 和 Math.round 的区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#101-toprecision-和-tofixed-和-mathround-的区别)
- [102. 什么是 XSS 攻击？如何防范 XSS 攻击？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#102-什么是-xss-攻击如何防范-xss-攻击)
- [103. 什么是 CSP？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#103-什么是-csp)
- [104. 什么是 CSRF 攻击？如何防范 CSRF 攻击？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#104-什么是-csrf-攻击如何防范-csrf-攻击)
- [105. 什么是 Samesite Cookie 属性？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#105-什么是-samesite-cookie-属性)
- [106. 什么是点击劫持？如何防范点击劫持？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#106-什么是点击劫持如何防范点击劫持)
- [107. SQL 注入攻击？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#107-sql-注入攻击)
- [108. 什么是 MVVM？比之 MVC 有什么区别？什么又是 MVP ？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#108-什么是-mvvm比之-mvc-有什么区别什么又是-mvp-)
- [109. vue 双向数据绑定原理？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#109-vue-双向数据绑定原理)
- [110. Object.defineProperty 介绍？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#110-objectdefineproperty-介绍)
- [111. 使用 Object.defineProperty() 来进行数据劫持有什么缺点？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#111-使用-objectdefineproperty-来进行数据劫持有什么缺点)
- [112. 什么是 Virtual DOM？为什么 Virtual DOM 比原生 DOM 快？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#112-什么是-virtual-dom为什么-virtual-dom-比原生-dom-快)
- [113. 如何比较两个 DOM 树的差异？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#113-如何比较两个-dom-树的差异)
- [114. 什么是 requestAnimationFrame ？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#114-什么是-requestanimationframe-)
- [115. 谈谈你对 webpack 的看法](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#115-谈谈你对-webpack-的看法)
- [116. offsetWidth/offsetHeight,clientWidth/clientHeight 与 scrollWidth/scrollHeight 的区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#116-offsetwidthoffsetheightclientwidthclientheight-与-scrollwidthscrollheight-的区别)
- [117. 谈一谈你理解的函数式编程？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#117-谈一谈你理解的函数式编程)
- [118. 异步编程的实现方式？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#118-异步编程的实现方式)
...
- [120. get 请求传参长度的误区](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#120-get-请求传参长度的误区)
- [121. URL 和 URI 的区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#121-url-和-uri-的区别)
...
- [129. 什么是尾调用，使用尾调用有什么好处？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#129-什么是尾调用使用尾调用有什么好处)
- [130. Symbol 类型的注意点？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#130-symbol-类型的注意点)
- [131. Set 和 WeakSet 结构？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#131-set-和-weakset-结构)
- [132. Map 和 WeakMap 结构？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#132-map-和-weakmap-结构)
- [133. 什么是 Proxy ？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#133-什么是-proxy-)
- [134. Reflect 对象创建目的？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#134-reflect-对象创建目的)
...
- [136. 什么是 Promise 对象，什么是 Promises/A 规范？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#136-什么是-promise-对象什么是-promisesa-规范)
...
- [138. 如何检测浏览器所支持的最小字体大小？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#138-如何检测浏览器所支持的最小字体大小)
- [139. 怎么做 JS 代码 Error 统计？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#139-怎么做-js-代码-error-统计)
- [140. 单例模式模式是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#140-单例模式模式是什么)
- [141. 策略模式是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#141-策略模式是什么)
- [142. 代理模式是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#142-代理模式是什么)
- [143. 中介者模式是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#143-中介者模式是什么)
- [144. 适配器模式是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#144-适配器模式是什么)
- [145. 观察者模式和发布订阅模式有什么不同？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#145-观察者模式和发布订阅模式有什么不同)
- [146. Vue 的生命周期是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#146-vue-的生命周期是什么)
- [147. Vue 的各个生命阶段是什么？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#147-vue-的各个生命阶段是什么)
- [148. Vue 组件间的参数传递方式？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#148-vue-组件间的参数传递方式)
- [149. computed 和 watch 的差异？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#149-computed-和-watch-的差异)
- [150. vue-router 中的导航钩子函数](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#150-vue-router-中的导航钩子函数)
- [151. $route 和 $router 的区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#151-route-和-router-的区别)
- [152. vue 常用的修饰符？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#152-vue-常用的修饰符)
- [153. vue 中 key 值的作用？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#153-vue中-key-值的作用)
- [154. computed 和 watch 区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#154-computed-和-watch-区别)
- [155. keep-alive 组件有什么作用？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#155-keep-alive-组件有什么作用)
- [156. vue 中 mixin 和 mixins 区别？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#156-vue-中-mixin-和-mixins-区别)
- [157. 开发中常用的几种 Content-Type ？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#157-开发中常用的几种-content-type-)
- [158. 如何封装一个 javascript 的类型判断函数？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#158-如何封装一个-javascript-的类型判断函数)
- [159. 如何判断一个对象是否为空对象？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#159-如何判断一个对象是否为空对象)
...
- [161. 手写一个 jsonp](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#161-手写一个-jsonp)
- [162. 手写一个观察者模式？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#162-手写一个观察者模式)
- [163. EventEmitter 实现](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#163-eventemitter-实现)
- [164. 一道常被人轻视的前端 JS 面试题](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#164-一道常被人轻视的前端js面试题)
- [165. 如何确定页面的可用性时间，什么是 Performance API？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#165-如何确定页面的可用性时间什么是-performance-api)
- [166. js 中的命名规则](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#166-js-中的命名规则)
- [167. js 语句末尾分号是否可以省略？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#167-js-语句末尾分号是否可以省略)
- [168. Object.assign()](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#168-objectassign)
- [169. Math.ceil 和 Math.floor](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#169-mathceil-和-mathfloor)
...
- [171. 一个列表，假设有 100000 个数据，这个该怎么办？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#171-一个列表假设有100000个数据这个该怎么办)
...
- [173. 进程间通信的方式？](https://github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/JavaScript/JavaScript.md#173-进程间通信的方式)
...
详细资料可以参考： [《JavaScript 深入理解之闭包》](http://cavszhouyou.top/JavaScript深入理解之闭包.html)
...
详细资料可以参考： [《JS 延迟加载的几种方式》](https://blog.csdn.net/meijory/article/details/76389762) [《HTML 5 `` `async` 属性》](http://www.w3school.com.cn/html5/att_script_async.asp)
...
详细的资料可以参考： [《JavaScript 深入之类数组对象与 arguments》](https://github.com/mqyqingfeng/Blog/issues/14) [《javascript 类数组》](https://segmentfault.com/a/1190000000415572) [《深入理解 JavaScript 类数组》](https://blog.lxxyx.cn/2016/05/07/深入理解JavaScript类数组/)
...
详细资料可以参考： [《JavaScript 深入理解之变量对象》](http://cavszhouyou.top/JavaScript深入理解之变量对象.html)
...
- 4.当需要多次访问数组长度时，可以用变量保存起来，避免每次都会去进行属性查找。DOM操作中使用变量保存某个dom节点，方便后续访问

- 5 数组遍历使用for循环，对象遍历使用for...in 
...
详细资料可以参考： [《Promises/A+ 规范》](http://www.ituring.com.cn/article/66566) [《Promise》](http://es6.ruanyifeng.com/#docs/promise#Promise-resolve)
...
详细资料可以参考： [《导航守卫》](https://router.vuejs.org/zh/guide/advanced/navigation-guards.html#全局前置守卫)
...
Math.round()  四舍五入
	1. 小数点后第一位大于0.5   结果是四舍五入后绝对值更大的数
	2. 小数点后第一位小于0.5   结果是四舍五入后绝对值更小的数
	3. 小数点后第一位等于0.5   结果是相邻的在正无穷方向上的整数
```
...
function findMostWord(article) {
  ...
  let wordList = article.match(/[a-z]+/g), // 得到所有单词组成的数组  my-app 属于两个单词my app
    visited = [], // 保存已经查询过次数的单词，下次再碰到相同的则不再查询
    maxNum = 0, // 初始最大次数
    maxWord = []; // 保存出现次数最多的元素，可能存在多个元素，所以初始化为数组

  // 将符合条件的单词组成一个以空格为间隔符的字符串
  article = " " + wordList.join("  ") + " ";
  // 遍历判断单词出现次数
  wordList.forEach(function (item) {
    // 查询整篇article中，item出现的次数
